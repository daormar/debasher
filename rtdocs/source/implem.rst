...
modules. In our example, there will be only one module, the
...
the most basic functionality provided by DeBasher. As it was mentioned
above, DeBasher works with three main entities: processes, programs and
modules, and it offers multiple alternatives to fully characterize them.

Instead of incorporating more detailed explanations here, it can be
interesting to provide a list of examples exploiting different aspects
of the Debasher's functionality. Such examples are described in the
following section.

...
proc_opts_symbols=("define_opt()" "define_infile_opt()" "define_flag()" "define_cmdline_opt()" "define_cmdline_opt_if_given()" "define_cmdline_infile_opt()" "define_cmdline_infile_opt_if_given()" "define_cmdline_flag_if_given()" "define_procspec_opt()" "define_fifo_opt()" "define_fifo_opt_generator()" "define_opt_from_proc_out()" "define_opt_from_proc_task_out()" "define_value_desc_opt()" "get_absolute_shdirname()" "define_opt_from_shared_dir()" "save_opt_list()")
...
proc_impl_symbols=("read_opt_value_from_func_args()" "read_flag_from_func_args()" "write_value_to_desc()")

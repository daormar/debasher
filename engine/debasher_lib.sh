...
# _PortWorker._apply_comp_specs): limits of a node, and the heartbeat
# timeout of a Supervisor, given per process with add_debasher_process.
# Each, when given, is a positive number.
DEBASHER_RESIDENT_COMP_SPEC_NAMES="input_log_max_mb out_backlog_max_mb out_backlog_fail_mb gil_switch_interval_ms heartbeat_timeout_s"

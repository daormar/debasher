...
# ARRAY OF ALL PROCESS VAR NAMES
...
# HEREDOC language suffixes are also valid process methods, since a
# process can provide its code through a suffixed function (e.g.
# "_py") looked up the same way as any other method.
DEBASHER_PROCESS_METHODS+=("${DEBASHER_PROCESS_VARNAMES[@]}")

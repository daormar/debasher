...
# PROCESS FUNCTION SUFFIXES
PROCESS_FUNC_SUFFIX_RESET_OUTDIR="_reset_outdir"
PROCESS_FUNC_SUFFIX_EXEC=""
PROCESS_FUNC_SUFFIX_POST="_post"
PROCESS_FUNC_SUFFIX_OUTDIR="_outdir_basename"
PROCESS_FUNC_SUFFIX_EXPLAIN_CMDLINE_OPTS="_explain_cmdline_opts"
PROCESS_FUNC_SUFFIX_DEFINE_OPTS="_define_opts"
PROCESS_FUNC_SUFFIX_SHOULD_EXECUTE="_should_execute"
PROCESS_FUNC_SUFFIX_CONDA_ENVS="_conda_envs"
PROCESS_FUNC_SUFFIX_FIFOS="_fifos"

# MODULE FUNCTION SUFFIXES
MODULE_FUNC_SUFFIX_SHRDIRS="_shared_dirs"
MODULE_FUNC_SUFFIX_PIPELINE="_pipeline"

...
def print_help():
    print(
        "solve_knapsack_bb -s <string> -c <string> [-t <float>]", file=sys.stderr)
...
def solve(items, weights, values, capacities, tlimit):
    ...
    solver = pywrapknapsack_solver.KnapsackSolver(
        pywrapknapsack_solver.KnapsackSolver.KNAPSACK_MULTIDIMENSION_BRANCH_AND_BOUND_SOLVER, 'problem')
...
def process_pars(flags, values):
    ...
    computed_value, packed_items, packed_weights = solve(
        items, weights, vals, capacities, values["time"])

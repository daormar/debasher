...
PY_VARNAME_SUFFIX="py"
PY_END_OF_OPTIONS_MARKER=""
R_VARNAME_SUFFIX="r"
R_END_OF_OPTIONS_MARKER="--"
PL_VARNAME_SUFFIX="perl"
PL_END_OF_OPTIONS_MARKER="--"
GROOVY_VARNAME_SUFFIX="groovy"
GROOVY_END_OF_OPTIONS_MARKER="--"
...
# PROCESS VAR NAMES
PROCESS_VARNAME_PYEXEC="${PROCESS_METHOD_SEP}${PY_VARNAME_SUFFIX}"
PROCESS_VARNAME_REXEC="${PROCESS_METHOD_SEP}${R_VARNAME_SUFFIX}"
PROCESS_VARNAME_PERLEXEC="${PROCESS_METHOD_SEP}${PL_VARNAME_SUFFIX}"
PROCESS_VARNAME_GROOVYEXEC="${PROCESS_METHOD_SEP}${GROOVY_VARNAME_SUFFIX}"
